-- Grant permissions to examduty_user
GRANT ALL ON SCHEMA common TO examduty_user;
GRANT ALL ON SCHEMA examduty TO examduty_user;
GRANT ALL ON ALL TABLES IN SCHEMA common TO examduty_user;
